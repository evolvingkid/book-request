      ...
      if ($result->num_rows > 0) {
          while($row = $result->fetch_assoc()) {?>
            <tr>
              ...
              <td> <a href="items.php?id=<?php echo $row['cat_id'] ?>&cat=<?php echo   $row["category_name"]; ?>"> <button type="button" name="button" class="round_corner_btn_in_table bg_blue">View</button> </a></td>
            </tr>
      <?php
        $count++;
        }
